...
public class DefaultExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity handleException(HttpStatus status, String message) {
        String localizedMessage = messageSource.getMessage(message, null,
                message, LocaleContextHolder.getLocale());
        ResponseMessage responsemsg = ResponseMessage.error(status.value(), localizedMessage);
